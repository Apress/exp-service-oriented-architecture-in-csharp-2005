...
namespace StockTraderConsole
{
	...
	class StockTraderConsole
	{
		...
		public void Run()
		{
			// Note: The console interacts with the StockTraderBusiness assembly directly

			// Create an instance of the StockTraderBusiness object
			StockTraderBusiness.StockTraderBusiness objST = new StockTraderBusiness.StockTraderBusiness();
			StockTraderTypes.Quote q = objST.RequestQuote("MSFT");

...
namespace StockTrader
{
    ...
    public class StockTrader : StockTraderStub 
    {
        ...
        public override Quote RequestQuote(string Symbol)
        {
            ...
            // Obtain information from the attached X509 certificate
            Console.WriteLine(RequestSoapContext.Current.Credentials.UltimateReceiver.GetClientToken<X509SecurityToken>().Certificate.SubjectName);
